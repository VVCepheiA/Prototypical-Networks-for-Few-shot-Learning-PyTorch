...
Example usage:
python train_all_tissues.py -exp ../output_all_tissues -nep 30 -testep 30 -its 50
python train_all_tissues.py -exp ../output_all_tissues_conv -nep 30 -testep 30 -its 50 -arch conv
"""
